...
/ Description: A stub for the Game class, representing individual game objects in the library.
/
*/
...
public class Game {
    ...
    public Game(String title, String genre, String console, int yearPublished, 
                int numAvail, int numRented, double price) {
        this.title = title;
        this.genre = genre;
